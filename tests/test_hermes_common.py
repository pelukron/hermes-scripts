...
class TestRetryRequest:
    def test_exito_primer_intento(self):
        ...
        with patch("src.hermes_common.common.requests.get", return_value=mock_resp) as mock_get:
    ...
    def test_retry_503_luego_exito(self):
        ...
        with patch(
            "src.hermes_common.common.requests.get",
    ...
    def test_retry_429_luego_exito(self):
        ...
        mock_200 = Mock(status_code=200)
        mock_200.raise_for_status.return_value = None
        with patch("src.hermes_common.common.requests.get", side_effect=[mock_429, mock_200]):
            with patch("src.hermes_common.common.time.sleep", return_value=None):
                result = retry_request(URL)
            assert result == mock_200
    ...
    def test_max_retries_agotados_503(self):
        ...
        with patch("src.hermes_common.common.requests.get", return_value=mock_503) as mock_get:
            with patch("src.hermes_common.common.time.sleep", return_value=None):
    ...
    def test_propaga_excepcion_no_retryable(self):
        ...
        with patch("src.hermes_common.common.requests.get", side_effect=ValueError("boom")):
