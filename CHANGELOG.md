...
- Sync uv.lock tras release [skip ci]
  ([`b54b4d7`](https://github.com/pelukron/hermes-scripts/commit/b54b4d76051c82d3a8ccae3f974694560bf62f84))

### 📝 Docs

- Entorno por sistema para no repetir los rojos locales
  ([#333](https://github.com/pelukron/hermes-scripts/pull/333),
  [`d2dab4a`](https://github.com/pelukron/hermes-scripts/commit/d2dab4a6723855b68e102a2d4dc81a6dfcbb162e))
...
- Sync uv.lock tras release [skip ci]
  ([`1b89881`](https://github.com/pelukron/hermes-scripts/commit/1b89881ef4fdfce725563ff62fffbf1ea5163484))

### 📝 Docs

- AGENTS.md registra gate-audit y la instalacion manual de jobs
  ([#330](https://github.com/pelukron/hermes-scripts/pull/330),
  [`2ace614`](https://github.com/pelukron/hermes-scripts/commit/2ace6141f78e31a43238e1491f384606c2e97fbf))
...
- Sync uv.lock tras release [skip ci]
  ([`e37bb8a`](https://github.com/pelukron/hermes-scripts/commit/e37bb8adba09b7ebd92b08fa02a194a182d19fc1))

### 🔧 Infra

- Matriz CI con python 3.13 y .python-version pinneado
  ([#304](https://github.com/pelukron/hermes-scripts/pull/304),
  [`898aa56`](https://github.com/pelukron/hermes-scripts/commit/898aa568ef1c0033657261849b400d37f2af6084))
